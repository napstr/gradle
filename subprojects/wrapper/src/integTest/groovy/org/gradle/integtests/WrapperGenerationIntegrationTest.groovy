...
class WrapperGenerationIntegrationTest extends AbstractIntegrationSpec {
    ...
    def "generated wrapper files are reproducible"() {
        ...
        Hashing.sha256().hashFile(file("first/gradle/wrapper/gradle-wrapper.jar")) == HashCode.fromString("b06b6ac387f3a2f8af2ee655673ee1cc5191024b36ed54ac5c52bf29e296478c")
